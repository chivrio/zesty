...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[3]=(Damage=78,InitialSpeed=8100.0,MaxSpeed=8400.0,AmmoCount=4,InitialGravityScale=0.25,Drag=0.000003,PitchCorrection=0)
    ...
    ReleaseAnimations(8)=(AnimationName=3p_crossbow_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longbow_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.42,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
