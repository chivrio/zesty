...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[3]=(Damage=78,InitialSpeed=8700.0,MaxSpeed=9000.0,AmmoCount=4,InitialGravityScale=0.25,Drag=0.000003,PitchCorrection=0)
    ...
    WindupAnimations(0)=(AnimationName=3p_crossbow_aim,ComboAnimation=,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.3,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false,bUseAltNode=true)
