...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[3]=(Damage=78,InitialSpeed=9000.0,MaxSpeed=9900.0,AmmoCount=4,InitialGravityScale=0.25,Drag=0.000003,PitchCorrection=0)
    ...
    ReloadAnimations[0]=(AnimationName=3p_crossbow_reloadheavy,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.heavy_crossbow_Reload',bFullBody=true,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.0,fAnimationLength=3.0,fBlendInTime=0.1,fBlendOutTime=0.20,bLastAnimation=true,bPlayOnWeapon=true,bAttachArrow=1)
