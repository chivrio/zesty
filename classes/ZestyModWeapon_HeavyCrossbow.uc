...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[3]=(Damage=78,InitialSpeed=8400.0,MaxSpeed=8700.0,AmmoCount=4,InitialGravityScale=0.25,Drag=0.000003,PitchCorrection=0)
    ...
    ReleaseAnimations(9)=(AnimationName=3p_crossbow_equipdown,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longbow_sheath',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.20,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ReloadAnimations[0]=(AnimationName=3p_crossbow_reloadheavy,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.heavy_crossbow_Reload',bFullBody=true,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.0,fAnimationLength=2.7,fBlendInTime=0.1,fBlendOutTime=0.20,bLastAnimation=true,bPlayOnWeapon=true,bAttachArrow=1)
