...
DefaultProperties
{
    ...
    ConfigProjectileBaseDamage[5]=(Damage=33,InitialSpeed=2300.0,MaxSpeed=2800.0,AmmoCount=1,InitialGravityScale=0.85,Drag=0.0000045,PitchCorrection=0)
    iFeintStaminaCost=0
    WeaponFontSymbol="R"
    ...
    WindupAnimations(0)=(AnimationName=3p_1hsharp_throwdowntoup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.doubleaxe_windup',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.45,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
