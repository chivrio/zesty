...
DefaultProperties
{
    ...
    NewPrimaryWeapons(3)=(CWeapon=class'ZestyModWeapon_LightCrossbow',CForceTertiary=(class'ZestyModWeapon_Buckler_Agatha'))
    NewPrimaryWeapons(4)=(CWeapon=class'ZestyModWeapon_Crossbow',CForceTertiary=(class'ZestyModWeapon_ThrowingKnife'))
