...
DefaultProperties
{
    ...
    NewPrimaryWeapons(3)=(CWeapon=class'ZestyModWeapon_Crossbow',CForceTertiary=(class'ZestyModWeapon_Buckler_Agatha'))
    ...
    NewTertiaryWeapons(0)=(CWeapon=class'ZestyModWeapon_Buckler_Agatha',bEnabledDefault=false)
    NewTertiaryWeapons(1)=(CWeapon=class'AOCWeapon_ProjBodkin',bEnabledDefault=false)
    NewTertiaryWeapons(2)=(CWeapon=class'AOCWeapon_ProjBroadhead',bEnabledDefault=false)
    NewTertiaryWeapons(3)=(CWeapon=class'AOCWeapon_ProjPebble',bEnabledDefault=false)
    NewTertiaryWeapons(4)=(CWeapon=class'AOCWeapon_ProjLeadBall',bEnabledDefault=false)
    NewTertiaryWeapons(5)=(CWeapon=class'AOCWeapon_PaviseShield_Agatha',bEnabledDefault=false)
    NewTertiaryWeapons(6)=(CWeapon=class'ZestyModWeapon_ThrowingKnife',bEnabledDefault=false)  
