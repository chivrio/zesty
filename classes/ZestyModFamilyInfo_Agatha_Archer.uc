...
DefaultProperties
{
    ...
    NewTertiaryWeapons(3)=(CWeapon=class'AOCWeapon_PaviseShield_Agatha',bEnabledDefault=false)
    NewTertiaryWeapons(4)=(CWeapon=class'ZestyModWeapon_Buckler_Agatha',bEnabledDefault=false)
