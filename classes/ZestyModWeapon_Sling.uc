class ZestyModWeapon_Sling extends ZestyModRangeWeapon;
...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[6]=(MinDamage=30.0f,Damage=18,InitialSpeed=5100.0,MaxSpeed=5400.0,AmmoCount=999,InitialGravityScale=0.6,Drag=0.0000045,PitchCorrection=0,bInfiniteAmmo=true,MinimumFireTime=0.425)
	ConfigProjectileBaseDamage[7]=(MinDamage=25.0f,Damage=39,InitialSpeed=5400.0,MaxSpeed=5700.0,AmmoCount=9,InitialGravityScale=0.65,Drag=0.0000055,PitchCorrection=0,bInfiniteAmmo=false,MinimumFireTime=0.6)
    iFeintStaminaCost=0
    WeaponFontSymbol="K"
    ...
    WindupAnimations(0)=(AnimationName=3p_sling_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Sling_attack_ready',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.45,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true)
    ...
    ReleaseAnimations(8)=(AnimationName=3p_sling_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.mace_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.24,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ReleaseAnimations(9)=(AnimationName=3p_sling_equipdown,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.mace_sheath',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.15,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ...
    ReloadAnimations[0]=(AnimationName=3p_sling_throwrecover,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=.7,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false)
