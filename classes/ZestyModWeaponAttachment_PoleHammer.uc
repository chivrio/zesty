...
KickOffset=(X=30, Y=0, Z=-36)
	...
	AttackTypeInfo(0)=(fBaseDamage=87, fForce=30000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=93, fForce=32000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=69, fForce=32000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
