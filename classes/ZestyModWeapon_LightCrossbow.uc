...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[3]=(Damage=51,InitialSpeed=6900.0,MaxSpeed=5400.0,AmmoCount=6,InitialGravityScale=0.35,Drag=0.000003,PitchCorrection=0)
    ...
    ReleaseAnimations(8)=(AnimationName=3p_crossbow_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longbow_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.30,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
