class ZestyModWeapon_OilPot extends AOCWeapon_OilPot;
...
DefaultProperties
{
    ...
    WeaponProjectiles(0)=class'ZestyModProj_ThrownOilPot'
    ...
    ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=1200.0,MaxSpeed=1500.0,AmmoCount=1,InitialGravityScale=0.9,Drag=0.000001,PitchCorrection=60.0)
    iFeintStaminaCost=0
    WeaponFontSymbol="k"
    WeaponReach=100
    ...
    ReleaseAnimations(8)=(AnimationName=3p_1hsharp_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.mace_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.6,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ReleaseAnimations(9)=(AnimationName=3p_1hsharp_equipdown,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.mace_sheath',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.6,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
