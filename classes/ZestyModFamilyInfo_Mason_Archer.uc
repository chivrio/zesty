...
DefaultProperties
{
    ...
    NewTertiaryWeapons(5)=(CWeapon=class'AOCWeapon_PaviseShield_Mason',bEnabledDefault=false)
    NewTertiaryWeapons(7)=(CWeapon=class'ZestyModWeapon_Buckler_Mason',bEnabledDefault=false)
    NewTertiaryWeapons(8)=(CWeapon=class'ZestyModWeapon_Buckler_Mason',bEnabledDefault=false)
