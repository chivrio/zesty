...
DefaultProperties
{
    ...
    NewPrimaryWeapons(3)=(CWeapon=class'ZestyModWeapon_Crossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason'))
    NewPrimaryWeapons(4)=(CWeapon=class'ZestyModWeapon_LightCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason'))
    ...
    NewTertiaryWeapons(1)=(CWeapon=class'ZestyModWeapon_Buckler_Mason',bEnabledDefault=false)
