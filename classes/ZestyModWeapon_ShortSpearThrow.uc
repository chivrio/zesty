...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[4]=(Damage=60,InitialSpeed=2500.0,MaxSpeed=2800.0,AmmoCount=5,InitialGravityScale=0.7,Drag=0.000003,PitchCorrection=0)
    ...
    ReleaseAnimations(0)=(AnimationName=3p_javelin_throwrelease,ComboAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_attack_01',bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.28,fBlendInTime=0.00,fBlendOutTime=0.10,bLastAnimation=false)
