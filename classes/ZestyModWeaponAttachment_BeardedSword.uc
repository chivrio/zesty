...
*/
class ZestyModWeaponAttachment_BeardedSword extends AOCWeaponAttachment_Longsword;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	AttackTypeInfo(0)=(fBaseDamage=105.0, fForce=30000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=117.0, fForce=30000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=30.0, fForce=30000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
