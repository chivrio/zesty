class ZestyModWeapon_Longbow extends ZestyModRangeWeapon
    dependson(AOCPawn);
...
DefaultProperties
{
     ...
     */
	ConfigProjectileBaseDamage[0]=(Damage=63,InitialSpeed=6000.0,MaxSpeed=6900.0,AmmoCount=6,InitialGravityScale=0.4,Drag=0.000003,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=63,InitialSpeed=6000.0,MaxSpeed=6900.0,AmmoCount=6,InitialGravityScale=0.4,Drag=0.000003,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=26,InitialSpeed=6000.0,MaxSpeed=6900.0,AmmoCount=6,InitialGravityScale=0.4,Drag=0.000003,PitchCorrection=0)
    ...
    WindupAnimations(0)=(AnimationName=3p_longbow_draw,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Longbow_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.87,fAnimationLength=0.96,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true)
    ...
    ReleaseAnimations(9)=(AnimationName=3p_longbow_equipdown,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longbow_sheath',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.17,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ...
    ReloadAnimations[0]=(AnimationName=3p_longbow_reload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.96,fBlendInTime=0.0,fBlendOutTime=0.10,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true,bAttachArrow=1)
