class ZestyModWeapon_SmokePot extends AOCWeapon_SmokePot;
...
DefaultProperties
{
    ...
    WeaponProjectiles(0)=class'ZestyModProj_ThrownNinjaPot'
    ...
    ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=2000.0,MaxSpeed=2500.0,AmmoCount=2,InitialGravityScale=1.0,Drag=0.000001,PitchCorrection=60.0)
    iFeintStaminaCost=0
    WeaponFontSymbol="*"
    WeaponReach=100
