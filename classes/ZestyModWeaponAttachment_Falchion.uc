...
KickOffset=(X=50, Y=0, Z=-65)
	...
	AttackTypeInfo(0)=(fBaseDamage=84.0, fForce=10000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=84.0, fForce=10000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
