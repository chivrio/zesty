...
DefaultProperties
{
	...
	WindupAnimations(2)=(AnimationName=3p_halberd_stabdowntoup,ComboAnimation=,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.725,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
	...
	RecoveryAnimations(2)=(AnimationName=3p_halberd_stabrecover,ComboAnimation=3p_halberd_stabrecover,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.82,fBlendInTime=0.10,fBlendOutTime=0.1,bLastAnimation=true)
