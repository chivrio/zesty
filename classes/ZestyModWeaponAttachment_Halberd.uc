...
KickOffset=(X=39, Y=0, Z=-42)
	...
	AttackTypeInfo(0)=(fBaseDamage=81.0, fForce=35000, cDamageType="ZestyMod.ZestyModDmgType_SwingPierceBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=84.0, fForce=34000, cDamageType="ZestyMod.ZestyModDmgType_SwingPierceBlunt", iWorldHitLenience=6)
