...
KickOffset=(X=36, Y=0, Z=-42)
	...
	AttackTypeInfo(0)=(fBaseDamage=69.0, fForce=30000, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=72.0, fForce=30000, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
