...
KickOffset=(X=39, Y=0, Z=-42)
	...
	AttackTypeInfo(0)=(fBaseDamage=99,0 fForce=38000, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=102.0, fForce=32000, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
