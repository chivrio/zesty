...
DefaultProperties
{
    ...
    WindupAnimations(0)=(AnimationName=3p_javelin_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.27,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
