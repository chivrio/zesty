...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[4]=(Damage=72,InitialSpeed=2700.0,MaxSpeed=3000.0,AmmoCount=4,InitialGravityScale=0.7,Drag=0.000003,PitchCorrection=0)
    ...
    WindupAnimations(0)=(AnimationName=3p_javelin_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.291,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
