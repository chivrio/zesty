class ZestyModWeapon_JavelinThrow extends AOCWeapon_JavelinThrow;
...
DefaultProperties
{
    ...
    AttachmentClass=class'ZestyModWeaponAttachment_JavelinThrow'
    ...
    AlternativeMode=class'ZestyModWeapon_JavelinMelee'
	...
	ConfigProjectileBaseDamage[4]=(Damage=72,InitialSpeed=2400.0,MaxSpeed=2700.0,AmmoCount=4,InitialGravityScale=0.7,Drag=0.000003,PitchCorrection=0)
    ...
    HorizontalRotateSpeed=81000.0
    VerticalRotateSpeed=69000.0
    AttackHorizRotateSpeed=81000.0
    ...
    WindupAnimations(0)=(AnimationName=3p_javelin_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.29,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
    WindupAnimations(1)=(AnimationName=,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.0,fAnimationLength=0.10,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
    ...
    ReleaseAnimations(0)=(AnimationName=3p_javelin_throwrelease,ComboAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_attack_01',bFullBody=false,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.29,fBlendInTime=0.05,fBlendOutTime=0.1,bLastAnimation=false,bAttachArrow=2)
    ...
    ReloadAnimations[0]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.36,fBlendInTime=0.0,fBlendOutTime=0.1,bLastAnimation=false,bAttachArrow=2)
    ReloadAnimations[1]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.36,fBlendInTime=0.0,fBlendOutTime=0.1,bLastAnimation=false,bAttachArrow=1)
    ReloadAnimations[2]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.36,fBlendInTime=0.0,fBlendOutTime=0.1,bLastAnimation=false,bAttachArrow=1)
    ReloadAnimations[3]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.36,fBlendInTime=0.0,fBlendOutTime=0.1,bLastAnimation=false,bAttachArrow=1)
