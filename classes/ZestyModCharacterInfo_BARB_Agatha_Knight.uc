...
* 
*/
class ZestyModCharacterInfo_BARB_Agatha_Knight extends AOCCharacterInfo_Knight;
...
defaultproperties
{
	...
	//GearData=(GearNameID=AgathaKnight,AppID=222360,bVisibleInSelectorIfUnowned=false)
	GearData=(GearNameID=BarbAgathaKnight)
