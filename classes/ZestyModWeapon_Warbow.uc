...
DefaultProperties
{
    ...
    // 0 - Bodkin
     ...
     // 5 - Default
    // 6 - Warbow arrow
	ConfigProjectileBaseDamage[0]=(Damage=75,InitialSpeed=7500.0,MaxSpeed=8100.0,AmmoCount=5,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=75,InitialSpeed=7500.0,MaxSpeed=8100.0,AmmoCount=5,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[2]=(Damage=75,InitialSpeed=7500.0,MaxSpeed=8100.0,AmmoCount=5,InitialGravityScale=0.55,Drag=0.000005,PitchCorrection=240.0)
