class ZestyModWeapon_Warbow extends ZestyModWeapon_Longbow;
...
DefaultProperties
{
    ...
    // 0 - Bodkin
     ...
     // 5 - Default
    // 6 - Warbow arrow
	ConfigProjectileBaseDamage[0]=(Damage=75,InitialSpeed=7800.0,MaxSpeed=8100.0,AmmoCount=5,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=75,InitialSpeed=7800.0,MaxSpeed=8100.0,AmmoCount=5,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[2]=(Damage=75,InitialSpeed=7800.0,MaxSpeed=8100.0,AmmoCount=5,InitialGravityScale=0.55,Drag=0.000005,PitchCorrection=240.0)
	...
	ConfigProjectileBaseDamage[6]=(Damage=75,InitialSpeed=6300.0,MaxSpeed=6600.0,AmmoCount=6,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
    iFeintStaminaCost=0
    WeaponFontSymbol="@"
    WeaponReach=100
    ...
    WindupAnimations(0)=(AnimationName=3p_longbow_draw,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Warbow_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.81,fAnimationLength=1.26,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true)
    ...
    ReleaseAnimations(8)=(AnimationName=3p_longbow_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longbow_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.36,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
