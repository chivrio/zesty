...
DefaultProperties
{
    ...
    // 0 - Bodkin
     ...
     // 5 - Default
    // 6 - Warbow arrow
	ConfigProjectileBaseDamage[0]=(Damage=75,InitialSpeed=5400.0,MaxSpeed=6000.0,AmmoCount=6,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=75,InitialSpeed=5400.0,MaxSpeed=6000.0,AmmoCount=6,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
	ConfigProjectileBaseDamage[2]=(Damage=75,InitialSpeed=5400.0,MaxSpeed=6000,AmmoCount=6,InitialGravityScale=0.55,Drag=0.000005,PitchCorrection=240.0)
	...
	ConfigProjectileBaseDamage[6]=(Damage=65,InitialSpeed=5400.0,MaxSpeed=6000.0,AmmoCount=6,InitialGravityScale=0.35,Drag=0.0000025,PitchCorrection=50)
    iFeintStaminaCost=0
    WeaponFontSymbol="@"
    WeaponReach=100
    ...
    ReloadAnimations[0]=(AnimationName=3p_longbow_reload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=1.335,fBlendInTime=0.0,fBlendOutTime=0.10,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true,bAttachArrow=1)
