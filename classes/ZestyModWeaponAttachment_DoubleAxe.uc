...
KickOffset=(X=36, Y=0, Z=-42)
	...
	AttackTypeInfo(1)=(fBaseDamage=135.0, fForce=30000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=30.0, fForce=35000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
