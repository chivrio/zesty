...
KickOffset=(X=39, Y=0, Z=-42)
	...
	AttackTypeInfo(0)=(fBaseDamage=141.0, fForce=37000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=141.0, fForce=31000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=42.0, fForce=34000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
