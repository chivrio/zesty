class ZestyModWeapon_HeavyJavelinThrow extends AOCWeapon_HeavyJavelinThrow;
...
DefaultProperties
{
    ...
    AttachmentClass=class'ZestyModWeaponAttachment_HeavyJavelinThrow'
    ...
    AlternativeMode=class'ZestyModWeapon_HeavyJavelinMelee'
	...
	ConfigProjectileBaseDamage[4]=(Damage=96,InitialSpeed=2400,MaxSpeed=2500,AmmoCount=3,InitialGravityScale=0.7,Drag=0.0000035,PitchCorrection=0)
    ...
    WindupAnimations(0)=(AnimationName=3p_javelin_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.3,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
    ...
    WindupAnimations(4)=(AnimationName=3p_javelin_parryib,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.warhammer_Parry',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.13,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
    ...
    ReleaseAnimations(0)=(AnimationName=3p_javelin_throwrelease,ComboAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_attack_01',bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.3,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
    ...
    ReleaseAnimations(8)=(AnimationName=3p_javelin_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.33,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ...
    ReloadAnimations[0]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.39,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=2)
    ReloadAnimations[1]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.39,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
    ReloadAnimations[2]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.39,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
    ReloadAnimations[3]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.39,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
