...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[4]=(Damage=96,InitialSpeed=2700,MaxSpeed=3000,AmmoCount=3,InitialGravityScale=0.7,Drag=0.0000035,PitchCorrection=0)
    ...
    ReleaseAnimations(0)=(AnimationName=3p_javelin_throwrelease,ComboAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_attack_01',bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.339,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
    ...
    ReloadAnimations[0]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.369,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=2)
    ReloadAnimations[1]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.369,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
    ReloadAnimations[2]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.369,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
    ReloadAnimations[3]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.99,fAnimationLength=0.369,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
