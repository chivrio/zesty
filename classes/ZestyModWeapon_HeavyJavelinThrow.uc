...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[4]=(Damage=96,InitialSpeed=2700,MaxSpeed=3300,AmmoCount=3,InitialGravityScale=0.7,Drag=0.0000035,PitchCorrection=0)
    ...
    ReleaseAnimations(0)=(AnimationName=3p_javelin_throwrelease,ComboAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_attack_01',bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.36,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
