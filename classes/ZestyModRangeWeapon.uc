class ZestyModRangeWeapon extends AOCRangeWeapon;
...
simulated function ChangeProjectileType(class<AOCProjectile> Proj) {
    ...
    if (class<ZestyModWeapon_Crossbow>(Class) != none && AOCOwner.PawnInfo.myTertiary == class'AOCWeapon_ExtraAmmo')
...
simulated state Active {
    simulated function BeginFire(byte FireModeNum) {
        ...
        else if (bLoaded || (FireModeNum == Attack_Overhead && ZestyModWeapon_Crossbow(self) != none))
