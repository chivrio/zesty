...
class ZestyModWeaponAttachment_HeavyJavelin extends AOCWeaponAttachment_HeavyJavelin;
...
KickOffset=(X=36, Y=0, Z=-42)
	...
	WeaponClass=class'ZestyModWeapon_HeavyJavelinMelee'
	...
	AttackTypeInfo(1)=(fBaseDamage=30.0, fForce=32500, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=66.0, fForce=20000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
