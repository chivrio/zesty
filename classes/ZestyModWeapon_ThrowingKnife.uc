class ZestyModWeapon_ThrowingKnife extends AOCWeapon_ThrowingKnife;
...
DefaultProperties
{
    ...
    ConfigProjectileBaseDamage[5]=(Damage=30,InitialSpeed=2500.0,MaxSpeed=3000.0,AmmoCount=3,InitialGravityScale=0.90,Drag=0.000005,PitchCorrection=200)
    iFeintStaminaCost=0
    WeaponFontSymbol="S"
    WeaponReach=100
    ...
    WindupAnimations(0)=(AnimationName=3p_throwingknife_downtoup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.shortsword_windup',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.42,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
    ...
    ReleaseAnimations(8)=(AnimationName=3p_throwingknife_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Knife_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.45,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ReleaseAnimations(9)=(AnimationName=3p_throwingknife_equipdown,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.knife_sheath',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.45,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    RecoveryAnimations(0)=(AnimationName=3p_throwingknife_recover,ComboAnimation=3p_throwingknife_slash011recover,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.3,fBlendInTime=0.00,fBlendOutTime=0.0,bLastAnimation=true)
