...
DefaultProperties
{
    ...
    ConfigProjectileBaseDamage[5]=(Damage=33,InitialSpeed=2400.0,MaxSpeed=3000.0,AmmoCount=3,InitialGravityScale=0.90,Drag=0.000005,PitchCorrection=200)
    iFeintStaminaCost=0
    WeaponFontSymbol="S"
    WeaponReach=100
    ...
    ReleaseAnimations(8)=(AnimationName=3p_throwingknife_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Knife_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.6,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
