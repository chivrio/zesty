...
DefaultProperties
{
     ...
     */
	ConfigProjectileBaseDamage[0]=(Damage=48,InitialSpeed=5700.0,MaxSpeed=6000.0,AmmoCount=8,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=48,InitialSpeed=5700.0,MaxSpeed=6000.0,AmmoCount=8,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=10,InitialSpeed=5700.0,MaxSpeed=6000.0,AmmoCount=8,InitialGravityScale=0.6,Drag=0.000004,PitchCorrection=0)
    ...
    ReleaseAnimations(8)=(AnimationName=3p_longbow_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longbow_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.21,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ReleaseAnimations(9)=(AnimationName=3p_longbow_equipdown,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.longbow_sheath',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.12,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
    ...
    ReloadAnimations[0]=(AnimationName=3p_longbow_reload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.6,fBlendInTime=0.0,fBlendOutTime=0.10,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true,bAttachArrow=1)
