...
KickOffset=(X=39, Y=0, Z=-42)
	...
	AttackTypeInfo(0)=(fBaseDamage=105.0, fForce=39000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=105.0, fForce=33000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=54.0, fForce=36000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
