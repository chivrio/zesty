...
KickOffset=(X=50, Y=0, Z=-65)
	...
	AttackTypeInfo(0)=(fBaseDamage=24.0, fForce=35000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=66.0, fForce=31500, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
